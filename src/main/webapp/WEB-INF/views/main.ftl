                        ...
                        <section class="tile transparent recent-activity">
                            ...
                            <div class="tile-body tab-content nopadding rounded-bottom-corners">
                                ...
                                <ul id="users-tab" class="tab-pane fade in active">
                                    <li>
                                        <img src="${basePath}/js/minimal/assets/images/peter-avatar.jpg" class="w35" alt>
                                    ...
                                    <li>
                                        <img src="${basePath}/js/minimal/assets/images/arnold-avatar.jpg" class="w35" alt>
                                    ...
                                    <li>
                                        <img src="${basePath}/js/minimal/assets/images/ici-avatar.jpg" class="w35" alt>
                                ...
                                <ul id="orders-tab" class="tab-pane fade">
                                    ...
                                    <li>
                                        <img src="${basePath}/js/minimal/assets/images/george-avatar.jpg" class="w35" alt>
                                ...
                                <ul id="messages-tab" class="tab-pane fade">
                                    <li>
                                        <img src="${basePath}/js/minimal/assets/images/profile-photo.jpg" class="w35" alt>
